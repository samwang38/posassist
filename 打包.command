...
mkdir -p "$OUT/$PKG/docs"
cp "$REPO/docs/inventory-trial.md" "$REPO/docs/inventory-roadmap.md" "$REPO/docs/inventory-validation.md" "$REPO/docs/native-integration-validation.md" "$OUT/$PKG/docs/"
